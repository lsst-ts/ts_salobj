...
class SALPYTestCase(unittest.TestCase):
    ...
    def test_salobj_remote_salobj_controller(self):
        self.check_salobj_remote("minimal_salobj_controller.py")

    def test_salobj_remote_salpy_controller(self):
        self.check_salobj_remote("minimal_salpy_controller.py")

    def check_salobj_remote(self, exec_name):
        async def doit():
