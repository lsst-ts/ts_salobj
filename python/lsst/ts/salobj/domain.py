...
class Domain:
    r"""Information about the Kafka environment.

    The name comes from DDS terminology; originally this held a
    ...
    Notes
    -----
    It is useful to close a `Domain` when you are done with it, especially
    in unit tests, because otherwise unreleased resources may cause warnings.
